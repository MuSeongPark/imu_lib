...
int32_t IMU_HWInit(void)
{
    ...
    int32_t whoami = I2C_ReadReg8(fd, WHO_AM_I);
...
Gyro_Vector GetGyroData(void)
{
    ...
    int16_t x_raw = (int16_t)(I2C_ReadReg8(fd, GYRO_XOUT_L) | (I2C_ReadReg8(fd, GYRO_XOUT_H) << 8));
    int16_t y_raw = (int16_t)(I2C_ReadReg8(fd, GYRO_YOUT_L) | (I2C_ReadReg8(fd, GYRO_YOUT_H) << 8));
    int16_t z_raw = (int16_t)(I2C_ReadReg8(fd, GYRO_ZOUT_L) | (I2C_ReadReg8(fd, GYRO_ZOUT_H) << 8));
